...
import src.remote_sync as remote_sync
from src.daily_exporter import DailyExporter
from src.remote_sync import join_remote_path, normalize_identity_file_path
...
def test_daily_exporter_upload_uses_rsync_helper(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr("src.daily_exporter.sync_files_via_rsync", fake_upload)
