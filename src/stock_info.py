...
from src.database import SessionLocal, StockInfo
...
class StockInfoCache:
    ...
    def get_stock_name(self, stock_code: str) -> str:
        ...
        try:
            ...
            stock_info = db.query(StockInfo).filter(
                StockInfo.stock_code == normalized_code
            ).first()
    ...
    def get_cache_stats(self) -> Dict[str, any]:
        ...
        try:
            ...
            valid_count = db.query(StockInfo).filter(
                StockInfo.updated_at > cutoff_time
            ).count()
