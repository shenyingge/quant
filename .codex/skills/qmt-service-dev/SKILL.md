...
description: Understand, modify, or debug the QMT automated trading service in this repository. Use when working on `main.py`, `src/trading_service.py`, Redis signal ingestion, QMT order execution, `.env` or `src/config.py`, notifications, backups, trading-day checks, SQLite persistence, or Windows task based operations and troubleshooting.
---
...
5. For operational questions, prefer logs, command entrypoints, and the scheduler scripts before touching trading logic.
